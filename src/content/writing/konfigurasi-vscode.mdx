...
pubDate: 2022-07-01
image: '/content/writing/editor.png'
slug: 'konfigurasi-text-editor-sejuta-umat'
---
...
Oke, sekarang masuk ke `setting.json`, perubahan yang gue lakukan di sini lumayan banyak dan ini juga yang membuat VScode gue terlihat lebih bersih (dan _aesthetic_) lagi.

```bash title="settings.json"
{
